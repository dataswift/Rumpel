...
describe('HatClaimComponent', () => {
  ...
  beforeEach(async(() => {
    TestBed.configureTestingModule({
      ...
      declarations: [ HatClaimComponent, HatClaimDetailsComponent, HatClaimNewPasswordComponent, HatClaimSubscriptionsComponent, HatClaimUrlComponent, HatClaimConfirmationComponent, HatClaimSuccessComponent ],
      providers: [
